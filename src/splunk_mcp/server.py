...
def build_server() -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "dashboards (splunk_list_dashboards / splunk_create_dashboard). Generate "
            "synthetic lab telemetry to populate dashboards without real devices "
            "(splunk_list_telemetry_profiles / splunk_generate_telemetry - 5 profiles, "
            "host prefix sim-). Use "
